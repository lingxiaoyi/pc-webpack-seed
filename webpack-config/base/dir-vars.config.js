...
// 生成文件目录
moduleExports.buildOnline = path.resolve(moduleExports.staticRootDir, '../../sports.eastday/sports.mop.com/tpl/src/msports') //猫扑体育线上目录
/*moduleExports.buildOnline = path.resolve(moduleExports.staticRootDir, './build_online')*/
